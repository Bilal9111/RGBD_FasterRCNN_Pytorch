...
class _fasterRCNN(nn.Module):
    ...
    def forward(self, im_data_a, im_info_a, gt_boxes_a, num_boxes_a, im_data_b, im_info_b, gt_boxes_b, num_boxes_b):
        ...
        # RGB here        
        batch_size_a = im_data_a.size(0)
        im_info_a = im_info_a.data
        gt_boxes_a = gt_boxes_a.data
        num_boxes_a = num_boxes_a.data

        # DEPTH here        
        batch_size_b = im_data_b.size(0)
        im_info_b = im_info_b.data
        gt_boxes_b = gt_boxes_b.data
        num_boxes_b = num_boxes_b.data
        ...
        base_feat = self.RCNN_base(im_data) # feeding the data in the RCNN_base to get the feature maps
