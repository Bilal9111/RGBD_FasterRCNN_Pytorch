...
if __name__ == '__main__':
  ...
  print("Use Depth: {}, Use Pretrained-model: {}".format(args.depth, args.if_pretrained))    
  
  
  
  output_dir = args.save_dir + "/" + "kitti_voc_dual_paths" + "/" + args.dataset # creating the directory used to store the net we will eventually create after training. This piece of code is a little out place
  ...
  imdb_depth, roidb_depth, ratio_list_depth, ratio_index_depth = combined_roidb("kitti_voc_trainval_depth")
  ...
  print("The optimizer being used is: {}".format(args.optimizer))
  ...
  for epoch in range(args.start_epoch, args.max_epochs + 1):
    ...
    data_iter_depth = iter(dataloader_depth) # Custom
    
    losses = []
    for step in range(iters_per_epoch):    	
      cfg.depth_only = False # We add an extra parameter to give signals to minibatch.py
